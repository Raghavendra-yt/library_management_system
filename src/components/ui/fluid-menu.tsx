  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-transparent cursor-pointer rounded-full group will-change-transform z-50"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-surface-container-high dark:bg-surface-container-high will-change-transform rounded-full shadow-sm border border-outline-variant/30"
            style={{
